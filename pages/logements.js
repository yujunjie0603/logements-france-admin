...
function Logements() {
  ...
  useEffect(() => {
    axios.get('/api/logements').then(response => {
  ...
  return (
    <Layout>
      ...
      <Link className="bg-blue-700 text-white py-1 px-1 rounded-md" href={'/logements/new'}>
        New logements
      </Link>
